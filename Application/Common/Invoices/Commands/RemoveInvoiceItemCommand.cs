...
namespace Application.Invoices.Commands
{
    public sealed record RemoveInvoiceItemCommand(
        Guid InvoiceId,
        string ItemName) : IRequest<InvoiceDto>;

    public sealed class RemoveInvoiceItemCommandHandler
        : IRequestHandler<RemoveInvoiceItemCommand, InvoiceDto>
    {
        private readonly IInvoiceRepository _invoiceRepository;
        private readonly IUnitOfWork _unitOfWork;

        public RemoveInvoiceItemCommandHandler(
